    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="<c:url value='/static/images/be-happy.jpg' />" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="<c:url value='/static/images/adult-attractive-beautiful-371160.jpg' />" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="<c:url value='/static/images/adult-black-leather-jacket-business-936127.jpg' />" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
